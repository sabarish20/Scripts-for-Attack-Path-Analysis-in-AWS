...
def check_perms(access_key_id, secret_access_key, region, session_token=None):
    ...
    required_permissions = [
        ...
        'iam:SetDefaultPolicyVersion', 'iam:PutUserPolicy', 'iam:PutRolePolicy'
    ]
    ...
    if found_permissions:
        ...
        print(f"{principal_type} {principal_name} does not have any of the specified risky permissions.")

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Check IAM permissions for the caller')
